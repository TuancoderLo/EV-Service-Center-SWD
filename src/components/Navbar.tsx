...
function UserAvatar({ user, onLogout, getDashboardUrl, isScrolled }: {
  user: any;
  onLogout: () => void;
  ...
  // Truncate long names
  const truncatedName = user.name.length > 12 ? `${user.name.substring(0, 12)}...` : user.name;
    ...
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white text-sm font-bold ${
          ...
          user.role === 'technician' ? 'bg-gradient-to-br from-orange-500 to-orange-600' :
      ...
      {/* Dropdown Menu */}
      {isDropdownOpen && (
        <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-2xl border border-gray-100 py-2 z-50 animate-in fade-in slide-in-from-top-5 duration-200">
          {/* User Info Header */}
    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
      ...
      <div className={`container mx-auto px-6 transition-all duration-300 ${
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <div className={`bg-gradient-to-br from-green-400 to-blue-500 rounded-xl flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:rotate-12 ${
            ...
            <div className="flex flex-col">
              ...
              <span className={`text-green-400 text-xs font-medium transition-all duration-300 ${
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            {user && (
              <Link
                href={getDashboardUrl(user.role)}
                className="ml-4 px-4 py-2 bg-green-500/20 text-green-400 rounded-lg hover:bg-green-500/30 hover:text-green-300 transition-all duration-300 font-medium border border-green-500/30"
              >
                Dashboard
              </Link>
            )}
          ...
          <div className="hidden md:flex items-center space-x-3">
            {!user ? (
              <div className="flex items-center space-x-3">
                ...
                <Link
                  href="/register"
                  className="bg-gradient-to-r from-green-500 to-blue-500 text-white px-6 py-2 rounded-full hover:from-green-600 hover:to-blue-600 transition-all duration-300 font-medium shadow-lg hover:shadow-green-500/25 hover:scale-105"
                >
                  Get Started
                </Link>
              </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-white/20 animate-in slide-in-from-top-2 duration-300">
            <div className="space-y-2 pt-4">
              <MobileNavLink href="#overview" onClick={() => setIsMenuOpen(false)}>
                Overview
              </MobileNavLink>
