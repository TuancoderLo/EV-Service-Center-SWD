...
export default function ResetPasswordPage() {
  ...
  // const token = searchParams.get("token"); // TODO: Use for API call later
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:border-green-500 focus:outline-none transition-all duration-200"
                placeholder="••••••••"
                {...register("password")}
              />
              <button
          ...
          {msg && (
            <div className={`rounded-lg p-4 ${msg.includes("thành công") ? "bg-green-50 border border-green-200" : "bg-red-50 border border-red-200"}`}>
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  <p className={`text-sm ${msg.includes("thành công") ? "text-green-700" : "text-red-700"}`}>{msg}</p>
                </div>
              </div>
            </div>
          )}
